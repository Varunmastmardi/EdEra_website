					...
					<div class="col">
						<div class="section_title_container text-center">
							...
							<div class="section_subtitle">
								<p>Welcome to Edera Learning: Your Gateway to Interactive Education!</p>
							</div>
						</div>
					</div>
				</div>
				<div class="row about_row">
					...
					<div class="col-lg-4 about_col about_col_left">
						<div class="about_item">
							...
							<div class="about_item_text">
								<p>At Edera, we're dedicated to offering a holistic learning journey. Our blend of
									theory and practice equips students with in-demand skills, ensuring hands-on
									experience. Through collaborations with professionals and companies, we tailor
									solutions to meet specific goals, driving success in the industry.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 about_col about_col_middle">
						<div class="about_item">
							...
							<div class="about_item_text">
								<p>Edera's mission is to redefine the landscape of education through innovation,
									technology, and personalized learning experiences. We strive to equip learners with
									the skills and knowledge needed to succeed in today's fast-paced world.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 about_col about_col_right">
						<div class="about_item">
							...
							<div class="about_item_text">
								<p>At Edera, we envision a future where education knows no boundaries. Our
									mission is to make learning accessible, engaging, and impactful for learners
									around the world, irrespective of geographical constraints.</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="section_title_container text-center">
							...
							<div class="section_subtitle">
								<p>
									When you choose us, you're choosing expertise, practical learning, and industry
									connections. Our seasoned team delivers top-notch education, ensuring hands-on
									experience to tackle real-world challenges. Partnering with professionals and
									companies, we provide tailored programs that foster personal and professional
									growth, backed by a track record of success stories
								</p>
							</div>
						</div>
					</div>
							...
							<div class="accordions">
								...
								<div class="elements_accordions">
									...
									<div class="accordion_container">
										...
										<div class="accordion_panel">
											<p>Upon completing the internship, we offer job placement based on
												performance and charge a single salary for our services.</p>
										</div>
									</div>
									...
									<div class="accordion_container">
										...
										<div class="accordion_panel">
											<p>Become certified in multiple cutting-edge and in-demand technologies
												through our comprehensive training programs.</p>
										</div>
									</div>

									<div class="accordion_container">
										<div class="accordion d-flex flex-row align-items-center">
											<div> CAREER CONSULTING </div>
										</div>
										<div class="accordion_panel">
											<p>Receive guidance from top career advisors worldwide and pave the way
												towards achieving your dream future.</p>
										</div>
									</div>
				...
				<div class="row">
					<div class="col">
						<div class="section_title_container text-center">
							...
							<div class="section_subtitle">
								<p>
									Our tutors, the best in town, bring a wealth of expertise, experience, and passion
									to each lesson, offering personalized attention and consistently delivering
									excellent results for our students.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-6">
						<div class="counter_content">
							...
							<div class="counter_text">
								<p>Unlock your potential - Register now for transformative learning!</p>
							</div>
						...
						<div class="col fill_height">
							<form
								...
								<select name="counter_select" id="counter_select" class="counter_input counter_options">
									...
									<option>Fullstack Web Development Using PHP!</option>
									<option>Fullstack Web Development Using Python</option>
									<option>Artificial Intelligence & Deep Learning</option>
									<option>Data Science Using Machine Learning</option>
						...
						<div class="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
							<div class="cr_text">
								...
								<script>document.write(new Date().getFullYear());</script> By <a
									href="https://colorlib.com" target="_blank">Edera</a>. All rights reserved.
