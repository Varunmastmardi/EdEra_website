...
var request_url="submitpayment.php";
    ...
    window.location.replace("http://localhost/unicat-master/paymentsuccess.php?oid="+orderID+"&rp_payment_id="+response.razorpay_payment_id+"&rp_signature="+response.razorpay_signature);

    },
    "modal": {
    "ondismiss": function(){
         window.location.replace("http://localhost/unicat-master/paymentsuccess.php?oid="+orderID);
     }
},
...
rzp1.on('payment.failed', function (response){
    ...
    window.location.replace("http://localhost/unicat-master/paymentfailed.php?oid="+orderID+"&reason="+response.error.description+"&paymentid="+response.error.metadata.payment_id);
