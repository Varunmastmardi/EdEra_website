					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_text">
								<p>Got a project in mind? We’d love to hear about it. Take five minutes to fill out our project
									form so that we can get to know you and understand your project.</p>
							</div>
							<div class="contact_info_location">
								<div class="contact_info_location_title">Office Address</div>
								<ul class="location_list">
									<li>Ganga Trueno Business Park, Air Force Area, New Airport Rd, Sanjay Park, Pune, Maharashtra 411014</li>
									<li>+91 9096649556</li>
