					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="contact_info">
								<div class="contact_info_title">REFUND POLICY</div>
								<div class="contact_info_location_title"></div>
								<div class="contact_info_text">
									<p>We strive for your satisfaction, hence, any qualifying courses bought on Edera are subject to a refund within a 7-day window. Should you find yourself dissatisfied with a course for any reason, you have the option to request a refund, ensuring that your request aligns with the criteria outlined in our refund policy.</p>

									<p>Please note that specific limitations may apply, and certain purchases may only qualify for credit refunds. For further details on our refund policy, kindly refer to the information provided below.</p>
								</div>


								<div class="contact_info_location_title">Our 7 Day policy :</div>
								<div class="contact_info_text">
									<p>Although our 7-day refund policy aims to offer students a risk-free learning experience, we also prioritize protecting our instructors from fraud and ensuring they receive fair compensation on a reasonable schedule. Therefore, any refund requests received after the specified window will not be processed.

									</p>
								</div>

								<div class="contact_info_location_title">Additional Reasons for Denied Refunds :</div>
								<div class="contact_info_text">
									<p>
									...
									<p>Users whose accounts are banned or whose course access is disabled due to a violation of our Terms will not be entitled to refunds. Refunds for subscription services will not be issued after the 7-day period.</p>
									<p>These refund restrictions will be enforced to the fullest extent permitted by applicable law.</p>
								</div>

								<div class="contact_info_location_title">Refunds for Bundles Purchased through a Third Party :</div>
								<div class="contact_info_text">
									<p>
